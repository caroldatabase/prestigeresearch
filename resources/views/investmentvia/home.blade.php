 ...
 <section id="about" class="padding">
      <div class="container">
        ...
        <div class="icon_wrapclearfix">
          <div class="col-sm-4 icon_box text-center margin_tophalf wow fadeInUp animated" data-wow-delay="300ms" style="visibility: visible; animation-delay: 300ms; animation-name: fadeInUp;">
             <img src="http://dev.investmentvia.co/storage/assets/images/icon1.png">
          ...
          <div class="col-sm-4 icon_box text-center margin_tophalf wow fadeInUp animated" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeInUp;">
              <img src="http://dev.investmentvia.co/storage/assets/images/icon2.png">
             <h4 class="text-capitalize bottom20 margin10">DERIVATIVES HNI</h4>
             <p class="no_bottom">Keep away from people who try to belittle your ambitions. Small people always do that but the really great.</p>
          </div>
          <div class="col-sm-4 icon_box text-center margin_tophalf wow fadeInUp animated" data-wow-delay="500ms" style="visibility: visible; animation-delay: 500ms; animation-name: fadeInUp;">
              <img src="http://dev.investmentvia.co/storage/assets/images/icon3.png">
             <h4 class="text-capitalize bottom20 margin10">NCDEX</h4>
             <p class="no_bottom">Keep away from people who try to belittle your ambitions. Small people always do that but the really great.</p>
          </div>
          <div class="col-sm-4 icon_box text-center margin_tophalf wow fadeInUp animated" data-wow-delay="500ms" style="visibility: visible; animation-delay: 500ms; animation-name: fadeInUp;">
             <img src="http://dev.investmentvia.co/storage/assets/images/icon4.png">
             <h4 class="text-capitalize bottom20 margin10">MCX BASIC</h4>
             <p class="no_bottom">Keep away from people who try to belittle your ambitions. Small people always do that but the really great.</p>
          </div>
          <div class="col-sm-4 icon_box text-center margin_tophalf wow fadeInUp animated" data-wow-delay="400ms" style="visibility: visible; animation-delay: 400ms; animation-name: fadeInUp;">
              <img src="http://dev.investmentvia.co/storage/assets/images/icon5.png">
             <h4 class="text-capitalize bottom20 margin10">EQUITY BASIC</h4>
             <p class="no_bottom">Keep away from people who try to belittle your ambitions. Small people always do that but the really great.</p>
          </div>
          <div class="col-sm-4 icon_box text-center margin_tophalf wow fadeInUp animated" data-wow-delay="500ms" style="visibility: visible; animation-delay: 500ms; animation-name: fadeInUp;">
              <img src="http://dev.investmentvia.co/storage/assets/images/icon6.png">
...
<div class="home-feature wow fadeInUp" data-wow-delay="500ms">
	<div class="container">
		<div class="row">
			<div class="col-sm-6">
				<h2>Let Know Our Feature - Prestige Research </h2>
        ...
        <div class="row">
            <div class="col-sm-4 border-right">
                <div class="what-content wow fadeInUp" data-wow-delay="500ms">
                    ...
                    <h3>WHO WE ARE ?</h3>
                    <p class="what-desc">We are a team that supports the accumulation of your wealth through different sources. A team that has market’s best advisors helps you to wade through a difficult phase. We Prestige Research  are always present to guide you to the right investment plans. Trust is what we offer you to be with us</p>
                </div>
            </div>
            <div class="col-sm-4 border-right">
                <div class="what-content wow fadeInUp" data-wow-delay="500ms""">
                    <p><img src="{{ asset('storage/assets/images/right-circle.jpg')}}"></p>
                    <h3>WHAT WE CARE ?</h3>
                    <p class="what-desc">Customer needs and satisfaction are the main concerns of Prestige Research . Our tips and services are the indeed portrayal of our work. Enhanced services along with the trials are being provided to take care of the security issues of our clients.</p>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="what-content wow fadeInUp" data-wow-delay="500ms""">
                    ...
                    <p class="what-desc">You don’t have to work on BSE/NSE to make money like BSE. Learn more how to trade with Prestige Research</p>
                </div>
            </div>
        </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div id="review_slider" class="owl-carousel text-center">
        ...
        <div class="item">
          <img src="{{ asset('storage/assets/images/customer1.png')}}" class="client_pic border_radius" alt="costomer">
          <p class="review_text">I totally and blindly follow Prestige Research  team for my trade in Stock Market because I know they will not let down me and always be there for me for support and efforts with their brilliant team. I wish them all the success for the future</p>
          <h4>Bala subramanya swamy</h4>
         
        </div>
        <div class="item">
          <img src="{{ asset('storage/assets/images/customer1.png')}}" class="client_pic border_radius" alt="costomer">
          <p class="review_text">Myself virendra pratap singh, client of Prestige Research  from past 2 months. I’m a new trader with very less knowledge about share market but want to trade and earn more from this market. Assent team gives me what I want from their excellent core Research and Sales team support. I’m so happy with their contribution to my success and now i give there to all my friends those who want to trade in this market. </p>
...
I am an intraday trader in Stock Cash and Stock Futures. Earlier I was skeptical about stock tips service. But one day I heard about this stock market advisory providing intraday stock tips. I just visited website and filled out stock tips free trial form for intraday trading tips. And what I got was maximum returns ever.
        ...
        <div class="item">
          <img src="{{ asset('storage/assets/images/customer1.png')}}" class="client_pic border_radius" alt="costomer">
          <p class="review_text">I am very happy with their calls & proper follow ups. My experience with Prestige Research is just amazing. I hope they will be able to always maintain their accuracy & services. </p>
