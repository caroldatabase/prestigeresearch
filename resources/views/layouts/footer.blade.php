  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-4 col-sm-4 footer_panel bottom25">
        ...
        <p class=" address"><i class="fa fa-map-marker" aria-hidden="true"></i>Prestige Research Advisory Service, Indore , India</p>
        <p class=" address"><i class="fa fa-phone" aria-hidden="true"></i>+91-9039921988</p>
